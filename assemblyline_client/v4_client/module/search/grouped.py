...
"""
    ...
    def retrohunt(self, field, group_sort=None, limit=None, query=None, filters=None,
                  offset=None, rows=None, sort=None, fl=None):
        """\
Search retrohunt collection and group retrohunt to a given field
...
Returns a generator that transparently and efficiently pages through results.
"""
        return self._do_grouped('retrohunt', field, group_sort=group_sort, limit=limit, query=query, filters=filters,
                                offset=offset, rows=rows, sort=sort, fl=fl)
