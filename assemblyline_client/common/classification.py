...
class Classification(object):
    ...
    def _get_c12n_groups(self, c12n, long_format=True, get_dynamic_groups=True,
                         auto_select=False):
        # Parse classifications in uppercase mode only
    ...
    def _get_normalized_classification_text(self, lvl_idx, req, groups, subgroups,
                                            long_format=True, skip_auto_select=False):
    ...
    def normalize_classification(self, c12n, long_format=True, skip_auto_select=False,
                                 get_dynamic_groups=True, ignore_unused=False):
        """
    ...
    def build_user_classification(self, c12n_1, c12n_2, long_format=True):
        """
